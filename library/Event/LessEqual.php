<?php
/**
 * Die Datei enthält die Klasse "{@link Event_LessEqual}"
 *
 * @category Heimdallr
 * @package Heimdallr
 * @subpackage Event
...
/**
 * Prüft, ob der Wert kleiner gleich X ist
 *
 * @category Heimdallr
 * @package Heimdallr
 * @subpackage Event
 ...
 * @author Kjell Dießel
 */
class Event_LessEqual extends Event_Equal
{
    ...
    public function verify(Heimdallr_TemplateAbstract $template, $key, $value)
    {
        ...
        if ($key == $this->getKey()) {
            // Ob der Wert kleiner gleich dem definierten Wert ist
