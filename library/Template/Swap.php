<?php
/**
 * Die Datei enthält die Klasse "{@link Template_Swap}"
 *
 * @category Heimdallr
 * @package Heimdallr
 * @subpackage Template
...
/**
 * Template für die Auslastung des SWAP's
 *
 * @category Heimdallr
 * @package Heimdallr
 * @subpackage Template
 ...
 * @author Kjell Dießel
 */
class Template_Swap extends Heimdallr_TemplateAbstract
{

    const VALUE_FREE  = 'swap_free';
    const VALUE_USAGE = 'swap_usage';
    ...
    {
        $title = $this->getServer()->getGraphTitle('SWAP Auslastung vom', '');
        $label = 'Bytes';
